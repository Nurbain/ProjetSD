...
public class Joueur extends Client{
	...
	public void tourDeJeu(){
		...
		case Mefiant : 
			...
			{
				//Cherche le producteur le plus rentable , c'est a dire celui qui possède le plus de ressource parmi les ressources dont le joueur a besoin
